...
if __name__ == '__main__':
    ...
    time.sleep(1)
    user_name = browser.find_element_by_name("EmailInput")
    user_name.send_keys("12@qq.com")
    time.sleep(0.54)
    pass_word = browser.find_element_by_name("EmailPasswordInput")
    pass_word.send_keys("12345abc")
    time.sleep(0.68)
    pass_word_confirm = browser.find_element_by_name("EmailPasswordConfirm")
    pass_word_confirm.send_keys("12345abc")
